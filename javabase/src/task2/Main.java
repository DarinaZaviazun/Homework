...
public class Main {
    public static void main(String[] args) {
        Movie movie1 = new Movie("Тайное окно", Duration.ofMinutes(90));
        Movie movie2 = new Movie("Пролетая над шнездом кукушки", Duration.ofMinutes(100));
        Movie movie3 = new Movie("Сияние", Duration.ofMinutes(70));
        Movie movie4 = new Movie("Оно", Duration.ofMinutes(103));
        Movie movie5 = new Movie("Кладбище домашних животных", Duration.ofMinutes(121));
        Movie movie6 = new Movie("Мизери", Duration.ofMinutes(111));
        Movie movie7 = new Movie("Рапунцель", Duration.ofMinutes(270));
